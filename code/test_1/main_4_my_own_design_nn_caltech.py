...
if __name__ == "__main__":
    ...
    num_epochs = 100
    save_dir_img = './saved_images_main_4_Sept_19_2024/'
    save_path = "../../model_bin/main_4_Sept_19_2024/" # Define the path where you want to save the checkpoints
    log_dir = "./log_main_4_Sept_19_2024/" # Ensure the log directory exists
    train_file_list = './list/caltech256_list.txt'
    val_file_list = './list/caltech101_list.txt'
