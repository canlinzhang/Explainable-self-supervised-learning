...
if __name__ == "__main__":
    ...
    num_epochs = 10
    latent_dim = 128
    save_dir_img = './saved_images_main_6_Sept_24_2024/'
    save_path = "../../model_bin/main_6_Sept_24_2024/" # Define the path where you want to save the checkpoints
    log_dir = "./log_main_6_Sept_24_2024/" # Ensure the log directory exists
