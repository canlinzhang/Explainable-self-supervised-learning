...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            ######block five##############
            #this layer is to reduce number of filters
            #to keep detail from image, we do not include maxpooling starting from this block
            nn.Conv2d(512, 256, 3, stride=1, padding=1),  # Changed from 1 to 3 for CIFAR-10 RGB channels
            nn.BatchNorm2d(256),
            nn.ReLU(),
            ...
            #this layer is to reduce number of filters
            #to keep detail from image, we do not include maxpooling starting from this block
            nn.Conv2d(256, 128, 3, stride=1, padding=1),  # Changed from 1 to 3 for CIFAR-10 RGB channels
            nn.BatchNorm2d(128),
            nn.ReLU(),
            ...
            #this layer is to reduce number of filters
            #to keep detail from image, we do not include maxpooling starting from this block
            nn.Conv2d(128, 64, 3, stride=1, padding=1),  # Changed from 1 to 3 for CIFAR-10 RGB channels
            nn.BatchNorm2d(64),
            nn.ReLU(),
            ...
            #this layer is to reduce number of filters
            #to keep detail from image, we do not include maxpooling starting from this block
            nn.Conv2d(64, 32, 3, stride=1, padding=1),  # Changed from 1 to 3 for CIFAR-10 RGB channels
            nn.BatchNorm2d(32),
            nn.ReLU(),
            
            nn.Conv2d(32, 32, 3, stride=1, padding=1),  # Changed from 1 to 3 for CIFAR-10 RGB channels
            nn.BatchNorm2d(32),
            nn.ReLU(),
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        train_loss = train_epoch_center_32(autoencoder, train_loader, criterion, optimizer, device)
        val_loss = validate_epoch_center_32(autoencoder, val_loader, criterion, device, epoch, 
